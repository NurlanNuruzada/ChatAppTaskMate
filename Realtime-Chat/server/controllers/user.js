...
export const googleAuth = async (req, res) => {
  try {
    ...
    const client = new OAuth2Client("20545796490-ql40fek1aucm3sjmombat2ksjpv854ik.apps.googleusercontent.com");
    const verify = await client.verifyIdToken({
      idToken: tokenId,
      audience: "20545796490-ql40fek1aucm3sjmombat2ksjpv854ik.apps.googleusercontent.com",
    });
    ...
    if (userExist) {
      ...
      const password = email + "20545796490-ql40fek1aucm3sjmombat2ksjpv854ik.apps.googleusercontent.com";
